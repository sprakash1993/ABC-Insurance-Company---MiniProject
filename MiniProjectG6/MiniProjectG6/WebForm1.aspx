<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="MiniProjectG6.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td>
                <asp:Button ID="Button4" CssClass="button blue" runat="server" OnClick="Button4_Click" Text="Get Details" CausesValidation="False" />
            </td>
        </tr>
        <tr>
            <td class="auto-style8">
       ...
       <tr>
        ...
        <tr>
            <td class="auto-style2" colspan="3">
                <asp:Button ID="Button1" CssClass="button blue" runat="server" Text="Update" OnClick="Button1_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button3" CssClass="button blue" runat="server" Text="Delete" Width="116px" OnClick="Button3_Click" />
            </td>
        </tr>
    </table>
        </center>
